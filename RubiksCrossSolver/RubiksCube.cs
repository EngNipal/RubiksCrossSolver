...
public sealed class RubiksCube
{
    ...
    public RubiksCube(string scramble) : this(Parse(scramble))
    {
    }
    ...
    public static uint[] GetStateByTurn(uint[] state, Turn turn)
    {
        ...
        switch (turn)
        {
            case Turn.R:
                {
                    // Углы красной грани 24-26-31-29-24
                    buffer = res[24];
                    res[24] = res[29];
                    res[29] = res[31];
                    res[31] = res[26];
                    ...
                    // Рёбра красной грани 25-28-30-27-25
                    buffer = res[25];
                    res[25] = res[27];
                    res[27] = res[30];
                    res[30] = res[28];
                    ...
                    // Углы первый набор 2-37-42-18-2
                    buffer = res[2];
                    res[2] = res[18];
                    res[18] = res[42];
                    res[42] = res[37];
                    ...
                    // Углы второй набор 7-32-47-23-7
                    buffer = res[7];
                    res[7] = res[23];
                    res[23] = res[47];
                    res[47] = res[32];
            ...
            case Turn.U:
                {
                    ...
                    // Углы первый набор 16-8-32-24-16
                    buffer = res[16];
                    res[16] = res[24];
                    res[24] = res[32];
                    res[32] = res[8];
                    ...
                    // Углы второй набор 18-10-34-26-18
                    buffer = res[18];
                    res[18] = res[26];
                    res[26] = res[34];
                    res[34] = res[10];
            ...
            case Turn.Up:
                {
                    ...
                    // Углы первый набор 16-24-32-8-16
                    buffer = res[16];
                    res[16] = res[8];
                    res[8] = res[32];
                    res[32] = res[24];
                    ...
                    // Углы второй набор 18-26-34-10-18
                    buffer = res[18];
                    res[18] = res[10];
                    res[10] = res[34];
                    res[34] = res[26];
            ...
            case Turn.F:
                {
                    // Углы зелёной грани 16-18-23-21-16
                    buffer = res[16];
                    res[16] = res[21];
                    res[21] = res[23];
                    res[23] = res[18];
                    ...
                    // Рёбра зелёной грани 17-20-22-19-17
                    buffer = res[17];
                    res[17] = res[19];
                    res[19] = res[22];
                    res[22] = res[20];
                    ...
                    // Углы первый набор 5-24-42-15-5
                    buffer = res[5];
                    res[5] = res[15];
                    res[15] = res[42];
                    res[42] = res[24];
                    ...
                    // Углы второй набор 7-29-40-10-7
                    buffer = res[7];
                    res[7] = res[10];
                    res[10] = res[40];
                    res[40] = res[29];
            ...
            case Turn.Fp:
                {
                    // Углы зелёной грани 16-21-23-18-16
                    buffer = res[16];
                    res[16] = res[18];
                    res[18] = res[23];
                    res[23] = res[21];
                    ...
                    // Рёбра зелёной грани 17-19-22-20-17
                    buffer = res[17];
                    res[17] = res[20];
                    res[20] = res[22];
                    res[22] = res[19];
                    ...
                    // Углы первый набор 5-15-42-24-5
                    buffer = res[5];
                    res[5] = res[24];
                    res[24] = res[42];
                    res[42] = res[15];
                    ...
                    // Углы второй набор 7-10-40-29-7
                    buffer = res[7];
                    res[7] = res[29];
                    res[29] = res[40];
                    res[40] = res[10];
            ...
            case Turn.F2:
                {
                    ...
                    // Углы первый набор 5-42 и 15-24
                    buffer = res[5];
                    res[5] = res[42];
                    res[42] = buffer;
                    buffer = res[15];
                    ...
                    // Углы второй набор 7-40 и 10-29
                    buffer = res[7];
                    res[7] = res[40];
                    res[40] = buffer;
                    buffer = res[10];
